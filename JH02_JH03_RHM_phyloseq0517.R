...
setwd("C:/Users/DB42008/Box Sync/Davide_lab_manuscripts/Senga_RHM_2016/RHM_R_analysis_revision_May2017/")
...
##############################################################
#Figure 2A: DNA concentration calculation, rhizosphere samples
...
#############################################################
#Figure 2B: reads distribution averall and whitin rhizosphre samples
#Data required: Dataset 2
#############################################################
...
#############################################################
#Figure 2C: Dry weight calculation
#Data required: Dataset 2
#############################################################
...
dat_info_taxa_Phylum <- read.delim("JH02_JH03_RHM_L2_visualisation.txt", skip=1, sep = "\t", header=T, row.names= 1, blank.lines.skip = FALSE)
...
dat_norm_Phylum <- dat_count_taxa_Phylum * 100 
dat_norm_Phylum[1:5, ]
...
barplot(Phylum_mean_topRank, main="Phylum Distribution",
        xlab="Samples", ylab = "Reads %", ylim = c(0,100), col=c("darkblue","red", "green", "cyan", "orange", "brown", "black", "magenta", "grey", "yellow"), beside=FALSE,   legend = rownames(Phylum_mean_topRank))
...
barplot(Phylum_mean_topRank, main="Phylum Distribution",
        xlab="Samples", ylab = "Reads %", ylim = c(0,100), col=c("darkblue","red", "green", "cyan", "orange", "brown", "black", "magenta", "grey", "yellow"), beside=FALSE)
...
#############################################################
#Figure 6 and 7: OTUs differentially recruited among samples
...
#Karat
Karat_rhizosphere_enriched_taxa_Quarry <- JH02_JH03_RHM_taxa_ordered[Soil_Rhizosphere_Karat_enriched_FDR001, ]
Karat_rhizosphere_enriched_FDR_001_Quarry_taxa <- cbind(as.data.frame(Soil_Rhizosphere_Karat[Soil_Rhizosphere_Karat_enriched_FDR001, ]), Karat_rhizosphere_enriched_taxa_Quarry)
#RHL1
RHL1_rhizosphere_enriched_taxa_Quarry <- JH02_JH03_RHM_taxa_ordered[Soil_Rhizosphere_RHL1_enriched_FDR001, ]
RHL1_rhizosphere_enriched_FDR_001_Quarry_taxa <- cbind(as.data.frame(Soil_Rhizosphere_RHL1[Soil_Rhizosphere_RHL1_enriched_FDR001, ]), RHL1_rhizosphere_enriched_taxa_Quarry)
#Dema
Dema_rhizosphere_enriched_taxa_Quarry <- JH02_JH03_RHM_taxa_ordered[Soil_Rhizosphere_Dema_enriched_FDR001, ]
Dema_rhizosphere_enriched_FDR_001_Quarry_taxa <- cbind(as.data.frame(Soil_Rhizosphere_Dema[Soil_Rhizosphere_Dema_enriched_FDR001, ]), Dema_rhizosphere_enriched_taxa_Quarry)
#RHP1
RHP1_rhizosphere_enriched_taxa_Quarry <- JH02_JH03_RHM_taxa_ordered[Soil_Rhizosphere_RHP1_enriched_FDR001, ]
RHP1_rhizosphere_enriched_FDR_001_Quarry_taxa <- cbind(as.data.frame(Soil_Rhizosphere_RHP1[Soil_Rhizosphere_RHP1_enriched_FDR001, ]), RHP1_rhizosphere_enriched_taxa_Quarry)

#save the files and combine them into Supplementary Database 1
#worksheet ws 10
#write.table(Karat_rhizosphere_enriched_FDR_001_Quarry_taxa, file="ws10.txt ", sep="\t")
#worksheet ws 11
#write.table(RHL1_rhizosphere_enriched_FDR_001_Quarry_taxa, file="ws11.txt ", sep="\t")
#worksheet ws 12
#write.table(Dema_rhizosphere_enriched_FDR_001_Quarry_taxa, file="ws12.txt ", sep="\t")
#worksheet ws 13
#write.table(RHP1_rhizosphere_enriched_FDR_001_Quarry_taxa, file="ws13.txt ", sep="\t")
...
#save the files and combine them into Supplementary Database 1
#worksheet ws 14
#write.table(Karat_enriched_vs_RHL1_FDR_001_2_Quarry_taxa, file="ws14.txt ", sep="\t")
#worksheet ws 15
#write.table(RHL1_enriched_vs_Karat_FDR_001_2_Quarry_taxa, file="ws15.txt ", sep="\t")
#worksheet ws 16
#write.table(Dema_enriched_vs_RHP1_FDR_001_2_Quarry_taxa, file="ws16.txt ", sep="\t")
#worksheet ws 17
#write.table(RHP1_enriched_vs_Dema_FDR_001_2_Quarry_taxa, file="ws17.txt ", sep="\t")
...
fig6a_Karat_RHL1_colors <- ifelse(rownames(Karat_RHL1) %in% Karat_RHL1_taxa_Burkholderiales , "darkorange",
...
fig6a_Dema_RHP1_colors <- ifelse(rownames(Dema_RHP1) %in% Dema_RHP1_taxa_Burkholderiales , "darkorange",
...
dev.off()
par(mfrow=c(2,1))            
plotMA(Karat_RHL1, alpha = 0.01, colSig = fig6a_Karat_RHL1_colors, colNonSig = "grey", ylim = c(-6, 6),  main="Karat vs. RHL1, Quarryfield")
plotMA(Dema_RHP1, alpha = 0.01, colSig = fig6a_Dema_RHP1_colors, colNonSig = "grey", ylim = c(-6, 6),   main="Dema vs. RHP1, Quarryfield")

#save the plots as .eps and generate Figure 6a
...
#create new datasets combining statisical and tanonomy information
#Karat
Karat_rhizosphere_enriched_taxa_Tayport <- JH02_JH03_RHM_taxa_ordered[Soil_Rhizosphere_Karat_enriched_FDR001, ]
Karat_rhizosphere_enriched_FDR_001_Tayport_taxa <- cbind(as.data.frame(Soil_Rhizosphere_Karat[Soil_Rhizosphere_Karat_enriched_FDR001, ]), Karat_rhizosphere_enriched_taxa_Tayport)
#RHL1
RHL1_rhizosphere_enriched_taxa_Tayport <- JH02_JH03_RHM_taxa_ordered[Soil_Rhizosphere_RHL1_enriched_FDR001, ]
RHL1_rhizosphere_enriched_FDR_001_Tayport_taxa <- cbind(as.data.frame(Soil_Rhizosphere_RHL1[Soil_Rhizosphere_RHL1_enriched_FDR001, ]), RHL1_rhizosphere_enriched_taxa_Tayport)
#Dema
Dema_rhizosphere_enriched_taxa_Tayport <- JH02_JH03_RHM_taxa_ordered[Soil_Rhizosphere_Dema_enriched_FDR001, ]
Dema_rhizosphere_enriched_FDR_001_Tayport_taxa <- cbind(as.data.frame(Soil_Rhizosphere_Dema[Soil_Rhizosphere_Dema_enriched_FDR001, ]), Dema_rhizosphere_enriched_taxa_Tayport)
#RHP1
RHP1_rhizosphere_enriched_taxa_Tayport <- JH02_JH03_RHM_taxa_ordered[Soil_Rhizosphere_RHP1_enriched_FDR001, ]
RHP1_rhizosphere_enriched_FDR_001_Tayport_taxa <- cbind(as.data.frame(Soil_Rhizosphere_RHP1[Soil_Rhizosphere_RHP1_enriched_FDR001, ]), RHP1_rhizosphere_enriched_taxa_Tayport)

#save the files and combine them into Supplementary Database 1
#worksheet ws 18
#write.table(Karat_rhizosphere_enriched_FDR_001_Tayport_taxa, file="ws18.txt ", sep="\t")
#worksheet ws 19
#write.table(RHL1_rhizosphere_enriched_FDR_001_Tayport_taxa, file="ws19.txt ", sep="\t")
#worksheet ws 20
#write.table(Dema_rhizosphere_enriched_FDR_001_Tayport_taxa, file="ws20.txt ", sep="\t")
#worksheet ws 21
#write.table(RHP1_rhizosphere_enriched_FDR_001_Tayport_taxa, file="ws21.txt ", sep="\t")

#Create a new dataset with Tayportfield rhizosphere samples
Karat_Tayport <- rownames(design_info_2)[which(design_info_2$Description == "Karat.tayport")]
Dema_Tayport <- rownames(design_info_2)[which(design_info_2$Description == "Dema.tayport")]
RHL1_Tayport <- rownames(design_info_2)[which(design_info_2$Description == "RHL1.tayport")]
RHP1_Tayport <- rownames(design_info_2)[which(design_info_2$Description == "RHP1.tayport")]
...
#save the files and combine them into Supplementary Database 1
#worksheet ws 22
#write.table(Karat_enriched_vs_RHL1_FDR_001_2_tayport_taxa, file="ws22.txt ", sep="\t")
#worksheet ws 23
#write.table(RHL1_enriched_vs_Karat_FDR_001_2_tayport_taxa, file="ws23.txt ", sep="\t")
#worksheet ws 24
#write.table(Dema_enriched_vs_RHP1_FDR_001_2_tayport_taxa, file="ws24.txt ", sep="\t")
#worksheet ws 25
#write.table(RHP1_enriched_vs_Dema_FDR_001_2_tayport_taxa, file="ws25.txt ", sep="\t")
#worksheet ws 26
#write.table(Karat_enriched_vs_Dema_FDR_001_2_tayport_taxa, file="ws26.txt ", sep="\t")
#worksheet ws 27
#write.table(Dema_enriched_vs_Karat_FDR_001_2_tayport_taxa, file="ws27.txt ", sep="\t")
...
fig6b_Karat_RHL1_colors <- ifelse(rownames(Karat_RHL1) %in% Karat_RHL1_taxa_Burkholderiales , "darkorange",
                       ifelse(rownames(Karat_RHL1) %in% Karat_RHL1_taxa_Rhizobiales , "deepskyblue",
                              ifelse(rownames(Karat_RHL1) %in% Karat_RHL1_taxa_Xanthomonadales , "forestgreen",
                                     ifelse(rownames(Karat_RHL1) %in% Karat_RHL1_taxa_Sphingomonadales , "magenta",
                                          ifelse(rownames(Karat_RHL1) %in% Karat_RHL1_taxa_Actinomycetales , "red",                                           
...
fig6b_Dema_RHP1_colors <- ifelse(rownames(Dema_RHP1) %in% Dema_RHP1_taxa_Burkholderiales , "darkorange",
                                  ifelse(rownames(Dema_RHP1) %in% Dema_RHP1_taxa_Rhizobiales , "deepskyblue",
                                         ifelse(rownames(Dema_RHP1) %in% Dema_RHP1_taxa_Xanthomonadales , "forestgreen",
                                                ifelse(rownames(Dema_RHP1) %in% Dema_RHP1_taxa_Sphingomonadales , "magenta",
                                                       ifelse(rownames(Dema_RHP1) %in% Dema_RHP1_taxa_Actinomycetales , "red",                                           
...
dev.off()
par(mfrow=c(2,1))            
plotMA(Karat_RHL1, alpha = 0.01, colSig = fig6b_Karat_RHL1_colors, colNonSig = "grey", ylim = c(-6, 6),  main="Karat vs. RHL1, Tayport")
plotMA(Dema_RHP1, alpha = 0.01, colSig = fig6b_Dema_RHP1_colors, colNonSig = "grey", ylim = c(-6, 6),   main="Dema vs. RHP1, Tayport")

#save the plots as .eps and combine them with plots generated at lines 768-772 to generate Figure 6
#############################################################

#############################################################
#Hypergeometric calculations: What is the probability that the identified orders are not just a consequence of the their enrichement in the rhizosphere

#probability that x number of OTUs belonging to a given order are differentially regulated by chance
rhizo_enriched_OTUs_wt <- unique(union((union(Soil_Rhizosphere_Karat_enriched_FDR001_Quarry, Soil_Rhizosphere_Dema_enriched_FDR001_Quarry)), (union(Soil_Rhizosphere_Karat_enriched_FDR001_Tayport, Soil_Rhizosphere_Dema_enriched_FDR001_Tayport)))) 
rhizo_enriched_OTUs_mutant <- unique(union((union(Soil_Rhizosphere_RHL1_enriched_FDR001_Quarry, Soil_Rhizosphere_RHP1_enriched_FDR001_Quarry)), (union(Soil_Rhizosphere_RHL1_enriched_FDR001_Tayport, Soil_Rhizosphere_RHP1_enriched_FDR001_Tayport)))) 
rhizo_enriched_OTUs <- unique(union(rhizo_enriched_OTUs_wt,rhizo_enriched_OTUs_mutant))

diff_enriched_OTUs_wt <- unique(union((union(Karat_enriched_vs_RHL1_FDR_001_2_Quarry, Dema_enriched_vs_RHP1_FDR_001_2_Quarry)), (union(Karat_enriched_vs_RHL1_FDR_001_2_tayport, Dema_enriched_vs_RHP1_FDR_001_2_tayport)))) 
diff_enriched_OTUs_mutant <- unique(union((union(RHL1_enriched_vs_Karat_FDR_001_2_Quarry, RHP1_enriched_vs_Dema_FDR_001_2_Quarry)), (union(RHL1_enriched_vs_Karat_FDR_001_2_tayport, RHP1_enriched_vs_Dema_FDR_001_2_tayport)))) 
diff_enriched_OTUs <- unique(union(diff_enriched_OTUs_wt,diff_enriched_OTUs_mutant))
                               
#total number of OTUs
length(rhizo_enriched_OTUs)
length(diff_enriched_OTUs)

#order identification
rhizo_enriched_taxa <- JH02_JH03_RHM_taxa_ordered[rhizo_enriched_OTUs , ]
rhizo_enriched_OTUs_order <- count(rhizo_enriched_taxa, "Order")
diff_enriched_taxa <- JH02_JH03_RHM_taxa_ordered[diff_enriched_OTUs, ]
diff_enriched_OTUs_order <- count(diff_enriched_taxa, "Order")

#Actinomycetales
#Total number of actinomycetales in the rhizo enriched
Actinomycetales_rhizo <- rhizo_enriched_OTUs_order[12, 2]
#Total OTUs rhizo enriched minus Actinomycetales
All_otus_rhizo_no_Actinomycetales <- length(rhizo_enriched_OTUs) - Actinomycetales_rhizo
#Actinomycetales among differntially regulated OTUs
Actinomycetales_diff <- diff_enriched_OTUs_order[7, 2]
#calculation
phyper(11, Actinomycetales_rhizo, All_otus_rhizo_no_Actinomycetales, length(diff_enriched_OTUs), lower.tail = FALSE)

#Burkholderiales
#Total number of Burkholderiales in the rhizo enriched
Burkholderiales_rhizo <- rhizo_enriched_OTUs_order[17, 2]
#Total OTUs rhizo enriched minus Burkholderiales
All_otus_rhizo_no_Burkholderiales <- length(rhizo_enriched_OTUs) - Burkholderiales_rhizo
#Burkholderiales among differntially regulated OTUs
Burkholderiales_diff <- diff_enriched_OTUs_order[10, 2]
#calculation
phyper(11, Burkholderiales_rhizo, All_otus_rhizo_no_Burkholderiales, length(diff_enriched_OTUs), lower.tail = FALSE)

#Rhizobiales
#Total number of Rhizobiales in the rhizo enriched
Rhizobiales_rhizo <- rhizo_enriched_OTUs_order[46, 2]
#Total OTUs rhizo enriched minus Rhizobiales
All_otus_rhizo_no_Rhizobiales <- length(rhizo_enriched_OTUs) - Rhizobiales_rhizo
#Rhizobiales among differntially regulated OTUs
Rhizobiales_diff <- diff_enriched_OTUs_order[18, 2]
#calculation
phyper(11, Rhizobiales_rhizo, All_otus_rhizo_no_Rhizobiales, length(diff_enriched_OTUs), lower.tail = FALSE)

#Sphingomonadales
#Total number of Sphingomonadales in the rhizo enriched
Sphingomonadales_rhizo <- rhizo_enriched_OTUs_order[57, 2]
#Total OTUs rhizo enriched minus Sphingomonadales
All_otus_rhizo_no_Sphingomonadales <- length(rhizo_enriched_OTUs) - Sphingomonadales_rhizo
#Sphingomonadales among differntially regulated OTUs
Sphingomonadales_diff <- diff_enriched_OTUs_order[25, 2]
#calculation
phyper(11, Sphingomonadales_rhizo, All_otus_rhizo_no_Sphingomonadales, length(diff_enriched_OTUs), lower.tail = FALSE)

#Xanthomonadales
#Total number of Xanthomonadales in the rhizo enriched
Xanthomonadales_rhizo <- rhizo_enriched_OTUs_order[63, 2]
#Total OTUs rhizo enriched minus Xanthomonadales
All_otus_rhizo_no_Xanthomonadales <- length(rhizo_enriched_OTUs) - Xanthomonadales_rhizo
#Xanthomonadales among differntially regulated OTUs
Xanthomonadales_diff <- diff_enriched_OTUs_order[26, 2]
#calculation
phyper(11, Xanthomonadales_rhizo, All_otus_rhizo_no_Xanthomonadales, length(diff_enriched_OTUs), lower.tail = FALSE)

##################################
#Figure 7: overlap enriched OTUs 
##################################

#Panels A, B: Quarryfield soil
#wild type 
length(Karat_enriched_vs_RHL1_FDR_001_2_Quarry)
length(Dema_enriched_vs_RHP1_FDR_001_2_Quarry)
length(intersect(Karat_enriched_vs_RHL1_FDR_001_2_Quarry, Dema_enriched_vs_RHP1_FDR_001_2_Quarry))
#venn diagram
dev.off()
draw.pairwise.venn(5, 4, 3, category = c("Karat enriched vs. RHL1", "Dema enriched vs. RHP1"), lty = rep("blank", 2), fill = c("cyan", "orange"), scaled = TRUE)

#mutants
length(RHL1_enriched_vs_Karat_FDR_001_2_Quarry)
length(RHP1_enriched_vs_Dema_FDR_001_2_Quarry)
length(intersect(RHL1_enriched_vs_Karat_FDR_001_2_Quarry, RHP1_enriched_vs_Dema_FDR_001_2_Quarry))
#venn diagram
dev.off()
draw.pairwise.venn(7, 29, 2, category = c("RHL1 enriched vs. Karat", "RHP1 enriched vs. Dema"), lty = rep("blank", 2), fill = c("darkblue", "magenta"), scaled = TRUE)

#Panels C, D: Tayport soil
#wild type 
length(Karat_enriched_vs_RHL1_FDR_001_2_tayport)
length(Dema_enriched_vs_RHP1_FDR_001_2_tayport)
length(intersect(Karat_enriched_vs_RHL1_FDR_001_2_tayport, Dema_enriched_vs_RHP1_FDR_001_2_tayport))
#venn diagram
grid.newpage()
draw.pairwise.venn(4, 6, 2, category = c("Karat enriched vs. RHL1", "Dema enriched vs. RHP1"), lty = rep("blank", 2), fill = c("cyan", "orange"), scaled = TRUE)

#mutants
length(RHL1_enriched_vs_Karat_FDR_001_2_tayport)
length(RHP1_enriched_vs_Dema_FDR_001_2_tayport)
length(intersect(RHL1_enriched_vs_Karat_FDR_001_2_tayport, RHP1_enriched_vs_Dema_FDR_001_2_tayport))
#venn diagram
grid.newpage()
draw.pairwise.venn(128, 64, 26, category = c("RHL1 enriched vs. Karat", "RHP1 enriched vs. Dema"), lty = rep("blank", 2), fill = c("darkblue", "magenta"), scaled = TRUE)

#diagram sizes edited and combined in Illustrator to generate Figrue 7

######################################################################################
#Pair-wise comparison Karat vs. Karat Control: evaluation of the sterilisation effeect
######################################################################################
